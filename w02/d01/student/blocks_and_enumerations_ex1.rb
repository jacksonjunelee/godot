...
contenders = ["Alabama", "Florida State", "Oregon", "Ohio State"]
contenders.join((', ') + "are in the playoffs.")
...
contenders.unshift("1")
contenders.delete_at(1)
# Hashes
#
...
contenders = {"Alabama and SEC", "Florida State and ACC", "Texas Christian University (TCU) and Big 12", "Baylor"}
