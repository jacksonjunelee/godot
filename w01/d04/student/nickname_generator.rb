...
def get_answer_to(entered_names)
  return entered_names
end

first_name_list.index("Bombadil")

first_name_list.delete("Snorkeldink")

first_name_list.push("Peter")

first_name_list.index("Brandybuck")

last_name_list.insert(44, "Vander Hoop")

first_name_list.delete("Muffinmitts")

last_name_list.slice!(0)

last_name_list.index("Scratchnsniff")

puts("Congrats, all done!")

# part 3

def generate_random_nickname(first_last)
  return first_last
end

first_name_list.sample(0.."Brandybuck")
