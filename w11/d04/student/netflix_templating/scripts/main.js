...
$(document).ready(function(){
  ...
  var $header = $("header"),
    ...
    // we pass the innerHTM of the template to the template fxn, which returns a function
    ...
    userHTML = generateUserHTML({ imgHREF: "https://pbs.twimg.com/media/BlJ8RFvCUAAMqW6.jpg:large", firstName: "Iris" });
